...
const ExpertScreen = () => {
  return (
    <div className="my-20 mx-20">
      ...
      <div className="grid grid-cols-4 gap-10 md:grid-rows  my-10">
        {[1, 1, 1, 1].map((item) => (
          <div className="w-[370px] h-[432px] relative  bg-gradient-to-t from-neutral-500 to-neutral-900 rounded-lg  ">
            <img
              className=" w-[380px] h-[432px] absolute object-cover rounded-lg mix-blend-overlay "
